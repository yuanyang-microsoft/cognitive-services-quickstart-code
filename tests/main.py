...
'''
# methods of searching projects in repo. could be useful in future to ensure all the quickstarts are defined in tests.json
...
def get_quickstarts():
    ...
    with open('tests.json') as f:
        for _ in json.load(f):
            ...
            elif _['runtime'] == 'javascript':
                yield JavascriptQuickStart(_)
            elif _['runtime'] == 'java':
                yield JavaQuickStart(_)
